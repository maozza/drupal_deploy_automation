...
$databases = array (
  ...
  array (
    'default' => 
    array (
      'database' => '{{ sql.drupal.db}}',
      'username' => '{{ sql.drupal.user }}',
      'password' => '{{ sql.drupal.password }}',
      'host' => '{{ sql.drupal.host }}',
      'port' => '',
      'driver' => 'mysql',
      'prefix' => '',
    ),
 ...
 *
 */
$drupal_hash_salt = 'd1UWVCecIjYQHQ5lg7BscBOM0L-tGmxoqwZCcAahp1c';
