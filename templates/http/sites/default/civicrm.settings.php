...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://{{ sql.drupal.user }}:{{ sql.drupal.password }}@{{ sql.drupal.host }}/{{ sql.drupal.db }}?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://{{ sql.civicrm.user }}:{{sql.civicrm.password }}@{{ sql.civicrm.host }}/{{ sql.civicrm.db }}?new_link=true');
  }
}
...
$civicrm_root = '/usr/share/nginx/compucorp/sites/all/modules/civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/usr/share/nginx/compucorp/sites/default/files/civicrm/templates_c/');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'https://compucorp.mozio.io/');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', 'da3d1e964244a696c6edc0308b7a1b40');
}
...
// define( 'CIVICRM_MAIL_LOG', '/usr/share/nginx/compucorp/sites/default/files/civicrm/templates_c//mail.log');
// }
